...
|     <img src="https://github.com/summerlane.png" width="80">     |      **이규화**       | **할 일 상세 도메인**<br/>- Task 칸반 보드 렌더링 및 드래그 앤 드롭<br/>- 할 일 상세 정보 조회 및 수정                | **모달(Modal)**<br/>**드롭다운(Dropdown)**      | [@summerlane](https://github.com/summerlane)                 |
|     <img src="https://github.com/dayeon0706.png" width="80">     |      **김다연**       | **게시판(Board) 도메인**<br/>- 자유로운 소통을 위한 게시판 CRUD<br/>- 베스트 게시글 캐러셀 및 댓글 기능               | **배지(Badge)**<br/>**칩(Chip)**                | [@dayeon0706](https://github.com/dayeon0706)                 |
|       <img src="https://github.com/Gyo50.png" width="80">        |      **오영교**       | **인증 & 랜딩 도메인**<br/>- 이메일/소셜(Kakao) 로그인 및 회원가입<br/>- 서비스 소개 랜딩 페이지 구현                 | **버튼(Button)**<br/>**인풋(Input)**            | [@Gyo50](https://github.com/Gyo50)                           |
| <img src="https://github.com/duddj122352-design.png" width="80"> |      **박지영**       | **할 일 목록(Task List) 도메인**<br/>- 주간/월간 캘린더 연동 Task 목록 조회<br/>- 나의 활동 히스토리 및 진행도 트래킹 | **캘린더(Calendar)**<br/>**Todo**<br/>**Toast** | [@duddj122352-design](https://github.com/duddj122352-design) |
